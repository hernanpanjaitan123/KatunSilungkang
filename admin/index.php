...
session_start();
    //koneksi ke database 
    $koneksi =  new mysqli("localhost","root","","mantap");
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><h4><strong>Admin Katun Silungkang</strong></h4></a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;"> Ktun Silungkang &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">keluar</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/cepo.jpg" class="user-image img-responsive"/>
					</li>
                    ...
                    <li><a href="index.php?halaman=pembelian"><i class="glyphicon glyphicon-shopping-cart fa-2x"></i>Pembelian</a></li>	
                    <li><a href="index.php?halaman=pelanggan "><i class="glyphicon glyphicon-user fa-2x"></i>Pelanggan</a></li>
                    <li><a href="index.php?halaman=ongkir"><i class="glyphicon glyphicon-plane fa-2x"></i>Ongkir</a></li>
                    <li><a href="index.php?halaman=packing"><i class="glyphicon glyphicon-gift fa-2x"></i>Packing</a></li>
